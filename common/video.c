...
#define VGA_COLOR_BIT_MASK 0xE71C

#define VGA_BLACK  0x0000 & VGA_COLOR_BIT_MASK
#define VGA_GREEN  0x0608 & VGA_COLOR_BIT_MASK
#define VGA_PURPLE 0xF9D6 & VGA_COLOR_BIT_MASK
#define VGA_ORANGE 0x12DD & VGA_COLOR_BIT_MASK
#define VGA_BLUE   0xE502 & VGA_COLOR_BIT_MASK
#define VGA_WHITE  0xFFDF & VGA_COLOR_BIT_MASK
